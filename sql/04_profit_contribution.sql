-- QUESTION: Which menu items generate the most total profit?
-- USE CASE: Prioritize high-profit items for promotions and identify underperformers
...
-- Combines recipe costs with sales volume to reveal total profit drivers
