...
Here is the query: [`05_top_bottom_performer.sql`](sql/05_top_bottom_performer.sql)
	a. I can see theres no problem with the amount of orders, just the amount of profit generated by each item. The difference between the top and bottom 3
